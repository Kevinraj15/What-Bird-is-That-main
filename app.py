...
st.set_page_config(page_title="ORNIS SPECIES IDENTIFICATION")  # Set tab title
...
st.sidebar.markdown("Created by [**kevin raj G**]")
st.sidebar.markdown(body="""

<th style="border:None"><a href="https://www.linkedin.com/in/kevin-raj-765670267/" target="blank">
